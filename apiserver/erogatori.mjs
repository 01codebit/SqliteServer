...
export async function erogatori_route(req, res) {
    ...
    console.error("[erogatori_route] query: \"" + sql + "\"");
    ...
    db.all(sql, [], (err, rows) => {
        ...
        // console.error("[erogatori_route] result: " + JSON.stringify(rows));
        console.error("[erogatori_route] found " + rows.length + " results");
